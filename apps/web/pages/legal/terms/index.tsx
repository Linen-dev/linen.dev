    ...
    <div className="relative py-16">
      <div className="lg:block lg:absolute lg:inset-y-0 lg:h-full lg:w-full">
        ...
        >
          ...
          <blockquote>
            <p>
              Welcome to <strong>Rebase Corporation</strong> (“
              <strong>Company</strong>”, “<strong>we</strong>”, “
              <strong>our</strong>”, “<strong>us</strong>”)! As you have just
            ...
            <p>
              ...
              <strong>Terms of Service</strong>”) govern your use of our web
              pages located at <a href="https://linen.dev">https://linen.dev</a>{' '}
              operated by Rebase Corporation
            </p>
            <p>
            ...
            <p>
              ...
              help@linen.dev so we can try to find a solution. These Terms apply
              to all visitors, users and others who wish to access or use
              Service.
            </p>
          ...
          <blockquote>
            ...
            <p>
              ...
              cancel it or Rebase Corporation cancels it. You may cancel your
              Subscription renewal either through your online account management
              page or by contacting Rebase Corporation customer support team.
            </p>
            <p>
              A valid payment method, including credit card, is required to
              process the payment for your subscription. You shall provide
              Rebase Corporation with accurate and complete billing information
              ...
              information, you automatically authorize Rebase Corporation to
          ...
          <blockquote>
            <p>
              Rebase Corporation may, at its sole discretion, offer a
            ...
            <p>
              ...
              Trial, you will not be charged by Rebase Corporation until Free
            ...
            <p>
              At any time and without notice, Rebase Corporation reserves the
          ...
          <blockquote>
            <p>
              Rebase Corporation, in its sole discretion and at any time, may
            ...
            <p>
              Rebase Corporation will provide you with a reasonable prior notice
          ...
          <blockquote>
            <p>
              We issue refunds for Contracts within thirty (30) days of the
          ...
          <blockquote>
            ...
            <p>
              ...
              <a href="https://policies.google.com/privacy?hl=en">
                <em>https://policies.google.com/privacy?hl=en</em>
              </a>
            </p>
            <p>
              ...
              <a href="https://support.google.com/analytics/answer/6004245">
                <em>https://support.google.com/analytics/answer/6004245</em>
              </a>
              .
            </p>
          </blockquote>
          <ol>
            <li>
              <span id="_Ref535534551" className="anchor"></span>
              <strong>
                <em>No Use By Minors</em>
              </strong>
            </li>
          </ol>
          <blockquote>
          ...
          <blockquote>
            <p>
              ...
              exclusive property of Rebase Corporation and its licensors.
              Service is protected by copyright, trademark, and other laws of
              the United States. Our trademarks and trade dress may not be used
              in connection with any product or service without the prior
              written consent of Rebase Corporation.
            </p>
          </blockquote>
          <ol>
            <li>
              <strong>
                <em>Error Reporting and Feedback</em>
              </strong>
            </li>
          </ol>
          <blockquote>
            <p>
              You may provide us either directly at help@linen.dev or via third
              ...
              <strong>Feedback</strong>”). You acknowledge and agree that: (i)
          ...
          <blockquote>
            ...
            <p>
              Rebase Corporation has no control over, and assumes no
          ...
          <ol>
            <li>
              <span id="_Ref535534624" className="anchor"></span>
              <strong>
                <em>Disclaimer Of Warranty </em>
              </strong>
            </li>
          </ol>
          <blockquote>
          ...
          <ol>
            <li>
              <span id="_Ref535534639" className="anchor"></span>
              <strong>
          ...
          <blockquote>
            <p>
              ...
              provisions.
              <span id="_Hlk2089641" className="anchor">
                <span id="_Hlk2089622" className="anchor">
                  <span id="_Hlk2098739" className="anchor"></span>
                </span>
              </span>
            </p>
            <p>
          ...
          <ol>
            <li>
              <span id="_Ref535534689" className="anchor"></span>
              <strong>
                <em>Waiver And Severability</em>
              </strong>
            </li>
          </ol>
          <blockquote>
          ...
          <ol>
            <li>
              <span id="_Ref535534766" className="anchor"></span>
              <strong>
