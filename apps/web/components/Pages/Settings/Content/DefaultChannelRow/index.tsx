...
type DropDownChannelsProps = {
  ...
  selected?: SerializedChannel;
  onChange: (channel: SerializedChannel) => void;
  hasAuth?: boolean;
  CommunityIcon: any;
};
        ...
        <div className="flex">
          ...
          <div className="self-center">
            {hasAuth ? (
              ...
              <p className="text-sm text-gray-400">Waiting for integration</p>
            )}
          </div>
        </div>
      </div>
...
export default function DefaultChannelRow({ channels, currentCommunity }: { channels: SerializedChannel[], currentCommunity: SerializedAccount }) {
  ...
  async function onDefaultChannelChange(channelSelected: SerializedChannel) {
