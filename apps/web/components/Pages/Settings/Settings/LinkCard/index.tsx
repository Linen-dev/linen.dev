...
export default function LinkCard({ account }: Props) {
  ...
  return (
    <div className="px-4 py-5 sm:p-6 flex flex-row justify-between">
      ...
      <a
        className="inline-flex items-center rounded-md border border-transparent bg-blue-700 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        href={url}
        target="_blank"
        rel="noreferrer"
      >
